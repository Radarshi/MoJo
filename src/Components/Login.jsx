...
function Login() {
  return (
    <div className='login template d-flex justify-content-center align-items-center vh-100 bg-primary backdrop-blur-md'>
      ...
      <form action="">
      <Link to="/" element={<Default/>}><img src={Return} alt="" className="return"/></Link>
        ...
        <div className="mb-2">
          ...
          <label htmlFor="check" className='custom-label-input text-black p-2'>
            Remember Me
          </label>
        </div>
      ...
      <a href="" style={{textDecoration:'none'}} className='text-black'>Forgot Password?</a>
      <Link to="/signin" element={<Signup/>} style={{textDecoration:'none',paddingLeft:'2px'}}>Sign Up</Link>
    </p>
      </form>
      </div>
    </div>
